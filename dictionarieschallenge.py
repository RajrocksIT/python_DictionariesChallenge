...
# SOlutions are  dictionarieschallenge1.py and dictionarieschallenge2.py
...
loc = 1   # starting point
while True:
    availableExits = ", ".join(exits[loc].keys())  # Used join instead of "for loop"
